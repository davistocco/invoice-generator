...
export class InvoiceEmitter {
  ...
  private async goToNotaControl() {
    await this.page.goto(`https://www.notaeletronica.com.br/${this.notaControlCity}/Login/Login_NFE.aspx`);
  }
